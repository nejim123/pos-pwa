                    ...
                    <form @submit.prevent="saveImage">
                        <div class="flex gap-3 md:gap-4">
                            ...
                            <button v-if="resetButton" @click="resetPreviewImage" type="button"
                                class="db-btn-outline h-[38px] shadow-[0px_6px_10px_rgba(251,_78,_78,_0.24)] !text-danger !bg-white !border-danger">
                            ...
                            <div class="w-full rounded-lg py-2 px-3 flex items-center gap-5 border border-[#EFF0F6]">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <router-link
                                            :to="{ name: 'admin.employees.order.details', params: { id: $route.params.id, orderId: order.id } }"
...
export default {
    ...
    computed: {
        ...
        myOrders: function () {
            return this.$store.getters['employee/myOrders'];
        },
        orderPagination: function () {
            return this.$store.getters["employee/orderPagination"];
        },
        orderPage: function () {
            return this.$store.getters["employee/orderPage"];
        },
    },
    mounted() {
    ...
    methods: {
        ...
        orderLists: function (page = 1) {
            ...
            this.$store.dispatch('employee/myOrders', {
        ...
        changePassword: function () {
            try {
                ...
                this.loading.isActive = true;
                this.$store
                    .dispatch("employee/changePassword", {
