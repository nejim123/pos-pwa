<template>
    ...
    <div class="col-12" v-if="Object.entries(waiter).length > 0">
                ...
                <div>
                    ...
                    <form @submit.prevent="saveImage">
                        <div class="flex gap-3 md:gap-4">
                            <label for="photo"
                                class="db-btn relative cursor-pointer h-[38px] shadow-[0px_6px_10px_rgba(105,_245,_216,_0.28)] bg-primary text-white">
                            ...
                            <div class="db-list-item p-0">
                                ...
                                <span class="db-list-item-text w-full sm:w-1/2">
                                    <span :class="statusClass(waiter.status)">
                                        {{ enums.statusEnumArray[waiter.status] }}
                                    </span>
                                </span>
                            </div>
                        </div>
        ...
        <div id="address" class="profile-tabDiv">
            <WaiterAddressList :props="$route.params.id" />
        </div>
                            ...
                            <div class="w-full rounded-lg py-2 px-3 flex items-center gap-5 border border-[#EFF0F6]">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <router-link
                                            :to="{ name: 'admin.waiters.order.details', params: { id: $route.params.id, orderId: order.id } }"
...
import WaiterAddressList from "./address/WaiterAddressList.vue";
import PaginationTextComponent from "../components/pagination/PaginationTextComponent";
import PaginationBox from "../components/pagination/PaginationBox";
import PaginationSMBox from "../components/pagination/PaginationSMBox";

export default {
    name: "WaiterShowComponent",
    components: {
        WaiterAddressList,
        LoadingComponent,
        PaginationSMBox,
    ...
    computed: {
        waiter: function () {
            return this.$store.getters["waiter/show"];
        },
        myOrders: function () {
            return this.$store.getters['waiter/myOrders'];
        },
        orderPagination: function () {
            return this.$store.getters["waiter/orderPagination"];
        },
        orderPage: function () {
            return this.$store.getters["waiter/orderPage"];
        },
    },
    mounted() {
        this.loading.isActive = true;
        this.$store
            .dispatch("waiter/show", this.$route.params.id)
            .then((res) => {
    ...
    methods: {
        ...
        orderLists: function (page = 1) {
            ...
            this.$store.dispatch('waiter/myOrders', {
        ...
        changePassword: function () {
            try {
                const tempId = this.$store.getters["waiter/temp"].temp_id;
                this.loading.isActive = true;
                this.$store
                    .dispatch("waiter/changePassword", {
