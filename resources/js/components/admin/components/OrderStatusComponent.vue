<template>
    ...
    <div
        ...
        <img v-if="parseInt(props.status) == parseInt(enums.orderStatusEnum.PREPARING)" class="w-32 h-32 mx-auto mb-3"
            :src="setting.image_order_preparing" alt="gif">
            <img v-if="parseInt(props.status) == parseInt(enums.orderStatusEnum.PREPARED)" class="w-32 h-32 mx-auto mb-3"
        ...
        <h5 v-if="parseInt(props.status) == parseInt(enums.orderStatusEnum.PENDING)"
            ...
            {{ $t("label.got_your_order", { name: name }) }}
        </h5>
        ...
        <h5 v-if="parseInt(props.status) == parseInt(enums.orderStatusEnum.PREPARING)"
            class="text-xs font-normal text-center mb-8">{{ $t("message.the_chef_is_preparing_your_food") }}</h5>
            <h5 v-if="parseInt(props.status) == parseInt(enums.orderStatusEnum.PREPARED)"
            class="text-xs font-normal text-center mb-8">{{ $t("message.order_ready_for_delivery") }}</h5>
