<template>
    ...
    <div class="col-12" v-if="Object.entries(chef).length > 0">
        ...
        <div id="address" class="profile-tabDiv">
            <ChefAddressList :props="$route.params.id" />
        </div>
                            ...
                            <div class="w-full rounded-lg py-2 px-3 flex items-center gap-5 border border-[#EFF0F6]">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <router-link
                                            :to="{ name: 'admin.chefs.order.details', params: { id: $route.params.id, orderId: order.id } }"
...
export default {
    ...
    computed: {
        chef: function () {
            return this.$store.getters["chef/show"];
        },
        myOrders: function () {
            return this.$store.getters['chef/myOrders'];
        },
        orderPagination: function () {
            return this.$store.getters["chef/orderPagination"];
        },
        orderPage: function () {
            return this.$store.getters["chef/orderPage"];
        },
    },
    mounted() {
        this.loading.isActive = true;
        this.$store
            .dispatch("chef/show", this.$route.params.id)
            .then((res) => {
    ...
    methods: {
        ...
        orderLists: function (page = 1) {
            ...
            this.$store.dispatch('chef/myOrders', {
        ...
        changePassword: function () {
            try {
                const tempId = this.$store.getters["chef/temp"].temp_id;
                this.loading.isActive = true;
                this.$store
                    .dispatch("chef/changePassword", {
