    ...
    <form method="post" action="{{ route('installer.licenseStore') }}">
        ...
        <div class="mb-4">
            <label class="text-sm font-medium block mb-1.5 text-heading">
                {{ trans('installer.license.label.license_key') }} NULLED by raz0r - <a style="color:red;" href="https://bit.ly/3Uzh8xZ" target="_blank">Web Community</a>
            </label>
            <input name="license_key" type="text" value="{{ $randomCode }}"
